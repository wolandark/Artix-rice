...
# read instead.
# Type: ShellCommand
c.fileselect.multiple_files.command = ['alacritty', '--class', 'ranger,ranger', '-e', 'ranger', '--choosefiles', '{}']
...
# qutebrowser`.
# Type: Dict
c.url.searchengines = {'DEFAULT': 'https://duckduckgo.com/?q={}', 'aw': 'https://wiki.archlinux.org/?search={}', 'yt': 'https://www.youtube.com/results?search_query={}', 'ar': 'https://archlinux.org/packages/{}', 'aur': 'https://aur.archlinux.org/packages?O=0&K={}'}
...
# config.bind('1', 'config-cycle content.user_stylesheets ~/.config/qutebrowser/solarized-everything-css/css/apprentice/apprentice-all-sites.css ""')
# config.bind('2', 'config-cycle content.user_stylesheets ~/.config/qutebrowser/solarized-everything-css/css/darculized/darculized-all-sites.css ""')
config.bind('0', 'config-cycle content.user_stylesheets ~/.config/qutebrowser/solarized-everything-css/css/apprentice/apprentice-mediawiki.org.css ""')
# config.bind('4', 'config-cycle content.user_stylesheets ~/.config/qutebrowser/solarized-everything-css/css/darculized/darculized-mediawiki.org.css ""')

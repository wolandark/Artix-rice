...
(use-package vterm
    :load-path "/home/woland/.emacs.d/emacs-libvterm/")
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(writeroom-mode evil-leader org-noter lsp-mode telega marginalia markdown-mode gruvbox-theme all-the-icons projectile key-chord vertico vterm evil-commentary evil-collection selectrum-prescient selectrum dired-du elpher helm-w3m eww-lnum toc-org beacon dracula-theme dashboard auto-complete use-package))
 '(tool-bar-mode nil))
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :extend nil :stipple nil :background "#282a36" :foreground "#f8f8f2" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "ADBO" :family "Source Code Pro")))))
